...
class TransfuserConfig:
    ...
    scheduler_type: str = "warmup_cos"

    trajectory_sampling: TrajectorySampling = TrajectorySampling(time_horizon=4, interval_length=0.5)
    
    image_architecture: str = "resnet34"
    lidar_architecture: str = "resnet34"
    resnet34_ckpt_path: str = f"path/to/resnet34_model.bin"
    ...
    num_sampling_proposals: int = 24
    flow_pred_x: bool = True
    cfg_scale: float = 0.5  # 0.0：uncond; 1.0: cond, 2.0: more cfg
    ...
    # loss weights
    flowmatching_loss_weight: float = 10.0
